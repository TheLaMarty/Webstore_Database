...
VALUES (1, 'Sundus', 'Abdulghani', 'Stockholm');
...
-- --------------- Product ------------------------
INSERT INTO Product (SKU, Brand, Name)
...
-- --------------- SKU ------------------------
INSERT INTO SKU (SKUID, ProductID, SizeID, Price, Stock)
VALUES (1, 1, 1, 2000, 1);

INSERT INTO SKU (SKUID, ProductID, SizeID, Price, Stock)
VALUES (2, 1, 2, 2000, 10);

INSERT INTO SKU (SKUID, ProductID, SizeID, Price, Stock)
VALUES (3, 1, 3, 2000, 5);

INSERT INTO SKU (SKUID, ProductID, SizeID, Price, Stock)
VALUES (4, 2, 1, 1889, 10);
...
FOR EACH ROW
  BEGIN
    INSERT IGNORE INTO OutOfStock (ProductOptionID, DATE ) SELECT (new.SKUID, current_date)
                                                           FROM SKU
                                                           WHERE Stock = 0;
END//
DELIMITER ;
